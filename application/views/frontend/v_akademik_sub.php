            ...
            <div class="col-md-8 mb-3">
                <div class="card shadow-md border-0">
                    <div class="card-header border-0 p-0" style="overflow: hidden;">
                        <img src="<?= base_url('gambar/' . $akademik_sub->akademik_sub_sampul) ?>" class="w-100" alt="<?= $akademik_sub->akademik_sub_judul ?>" style="object-fit: cover; max-height: 50vh;">
                    </div>
                    <div class="card-body">
                        <h1 class="h5 text-uppercase" style="letter-spacing: .5px;"><?= $akademik_sub->akademik_sub_judul ?></h1>
                        <span class="text-muted" style="font-style: italic; font-size: 12px;"><?= date('d M Y', strtotime($akademik_sub->akademik_sub_tanggal)) ?></span> <br>
                        <article class="mt-4" style="font-size: 15px;"><?= $akademik_sub->akademik_sub_content ?></article>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
