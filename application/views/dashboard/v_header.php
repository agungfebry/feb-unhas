...
<head>
	...
	<title>FEBUNHAS | Dashboard</title>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li>
						<a href="<?php echo base_url() . 'backend/pengumuman' ?>">
							<i class="fa fa-dashboard"></i>
							<span>PENGUMUMAN</span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url() . 'backend/galery' ?>">
							<i class="fa fa-dashboard"></i>
							<span>GALERY</span>
						</a>
					</li>
					...
					<li>
						<a href="<?php echo base_url() . 'backend/akademik' ?>">
					...
					<li>
						<a href="<?php echo base_url() . 'backend/pembelajaran' ?>">
							<i class="fa fa-user"></i>
							<span>PEMBELAJARAN</span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url() . 'backend/kode_perilaku' ?>">
							<i class="fa fa-user"></i>
							<span>KODE PERILAKU</span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url() . 'backend/jaminan_mutu' ?>">
							<i class="fa fa-user"></i>
							<span>JAMINAN MUTU</span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url() . 'backend/dokumen' ?>">
							<i class="fa fa-user"></i>
							<span>DOKUMEN</span>
						</a>
					</li>
